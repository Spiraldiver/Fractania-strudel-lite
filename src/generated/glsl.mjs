// GENERATED Fractania shader chunks -- do not edit by hand.
...
`;
export const TRANSFORMS = String.raw`
...
`;
export const FORMULA_UNIFORMS = String.raw`
...
`;
export const MAIN_PT = String.raw`
// === TF_OPS_SECTION_BEGIN ===
// (no TF-port operators connected — uniforms + helper funcs go here when an
//  OpRef custompar is set, see the builder())
// === TF_OPS_SECTION_END ===
...
export const VARIANT_NAMES = ["Mandelbulb", "Menger"];
export const TRANSFORM_SNIPPETS = {
